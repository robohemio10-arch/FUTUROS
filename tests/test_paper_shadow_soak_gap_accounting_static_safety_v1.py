...
SCANNED_PATHS = (
    ROOT / "smartcrypto" / "ops" / "paper_shadow_soak_gap_accounting",
    ROOT / "scripts" / "audit_paper_shadow_soak_continuity_and_gap_accounting.py",
)
FORBIDDEN_PATTERNS = (
    "import ccxt",
    "ccxt.",
...
def test_gap_accounting_has_no_operational_side_effect_imports() -> None:
    offenders: list[str] = []
