#!/usr/bin/env python3
"""Build the research-only AI feature source fields enrichment contract."""
...
from smartcrypto.learning.feature_source_fields_enrichment_contract import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="append",
        default=None,
        help="Optional source field override for audits/tests. Can be repeated.",
    )
...
def main() -> int:
    ...
    report = build_ai_feature_source_fields_enrichment_contract_v1(
        ...
        available_fields=args.available_field,
        write_report=bool(args.write and not args.no_write),
