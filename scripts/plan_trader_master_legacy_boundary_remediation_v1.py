#!/usr/bin/env python3
"""Build a deterministic no-write plan for legacy Trader Master boundary findings."""
...
from smartcrypto.data.trader_master_fingerprint_v2.legacy_master_remediation_plan import (  # noqa: E402
    DEFAULT_JSON_REPORT,
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_remediation_plan_report(
