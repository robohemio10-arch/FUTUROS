#!/usr/bin/env python3
"""Build the research-only AI/Qlib drift and regime monitor report."""
...
from smartcrypto.learning.ai_qlib_drift_regime_monitor import build_ai_qlib_drift_regime_monitor_v1  # noqa: E402
...
def main() -> int:
    ...
    report = build_ai_qlib_drift_regime_monitor_v1(
