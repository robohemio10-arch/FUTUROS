#!/usr/bin/env python3
"""Inventory joinable authoritative evidence for legacy Trader Master cohorts."""
...
from smartcrypto.data.trader_master_fingerprint_v2.authoritative_evidence_inventory import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="append",
        dest="evidence_roots",
        help="Repeatable project-relative discovery root; defaults to data/backups/docs/config.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_trader_master_authoritative_evidence_inventory_report(
        ...
        evidence_roots=args.evidence_roots or DEFAULT_EVIDENCE_ROOTS,
