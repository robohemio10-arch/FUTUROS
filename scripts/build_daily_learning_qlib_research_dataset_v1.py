#!/usr/bin/env python
"""CLI for the SMART FUTUROS Qlib research dataset contract."""
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build the Daily Learning Qlib research dataset payload."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report["validation_errors"] = sorted(
        set(validate_daily_learning_qlib_research_dataset_report(report))
