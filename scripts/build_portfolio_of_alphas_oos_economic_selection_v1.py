#!/usr/bin/env python3
"""Build Branch 15 Portfolio of Alphas OOS economic selection evidence."""
...
from smartcrypto.research.portfolio_of_alphas import (  # noqa: E402
    oos_economic_selection as selection,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = selection.build_portfolio_of_alphas_oos_economic_selection_v1(
        ...
        sleeve_evidence_path=args.sleeve_evidence,
    )
    print(
        json.dumps(
            report,
