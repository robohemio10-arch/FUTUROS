#!/usr/bin/env python3
"""Audit the Qlib research backend environment lock without installing packages."""
...
from smartcrypto.learning.qlib_backend_environment_lock import build_qlib_environment_lock_report  # noqa: E402
