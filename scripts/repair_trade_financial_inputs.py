...
DEFAULT_OUTPUT = Path("data/features/trade_financial_inputs_repaired.parquet")
DEFAULT_REPORT = Path("data/reports/trade_financial_input_repair_report.json")


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Repair trade financial inputs for offline research only.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        repaired, report = repair_trade_financial_inputs(
            frame,
