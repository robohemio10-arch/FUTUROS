...
Esta branch cria a consolidação institucional das métricas financeiras reais do paper trading no SmartCrypto. A pergunta central e simples: o paper está gerando edge financeiro mensurável ou apenas ruído operacional?
