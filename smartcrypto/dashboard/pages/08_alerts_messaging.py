...
PAGE_NUMBER = "08"
PAGE_NAME = "Alertas & Mensageria"
PAGE_SUBTITLE = "Centro de alertas snapshot-first; provedores externos permanecem simulados."
ACTIVE_PAGE = "08_alerts_messaging"
...
def render_page(snapshot: dict[str, Any], *, ui: Any | None = None) -> None:
    ...
    render_footer_audit_bar(
        SNAPSHOT_PATH,
        ["STUB ONLY - NO TELEGRAM/NTFY SEND"],
        ui=target_ui,
    )
